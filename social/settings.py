...
Most settings between running the application and testing can be found in
social/settings_base.py.

Some settings are read in as environmental variables and have common sense
defaults set.  The required environmental variables can be found in env.dist in
the base of the project.  It should be renamed to .env and filled out
"""
